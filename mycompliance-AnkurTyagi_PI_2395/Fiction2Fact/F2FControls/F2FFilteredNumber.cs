...
{
    [ToolboxData("<{0}:F2FFilteredNumber runat=server></{0}:F2FFilteredNumber>")]
    [DefaultProperty("ValidChars")]
    [RequiredScript(typeof(CommonToolkitScripts))]
    [TargetControlType(typeof(TextBox))]
    public class F2FFilteredNumber : FilteredTextBoxExtender
    {
        //[ClientPropertyName("filterInterval")]
        //[DefaultValue(250)]
        //[ExtenderControlProperty]
        //public new int FilterInterval { get; set; }
        //[ClientPropertyName("filterMode")]
        //[DefaultValue(FilterModes.ValidChars)]
        //[ExtenderControlProperty]
        //public new FilterModes FilterMode { get; set; }
        //[ClientPropertyName("filterType")]
        ////[DefaultValue(FilterTypes.Custom)]
        //[ExtenderControlProperty]
        //public new FilterTypes FilterType { get; set; }
        //[ClientPropertyName("invalidChars")]
        //[DefaultValue("")]
        //[ExtenderControlProperty]
        //public new string InvalidChars { get; set; }
        //[ClientPropertyName("validChars")]
        //[DefaultValue("")]
        //[ExtenderControlProperty]
        //public new string ValidChars { get; set; }
        public F2FFilteredNumber()
        {
            string strFilterMode = ConfigurationManager.AppSettings.AllKeys.Contains("NumberFilterMode") ? ConfigurationManager.AppSettings["NumberFilterMode"].ToString() : "ValidChars";
            string strFilterType = ConfigurationManager.AppSettings.AllKeys.Contains("NumberFilterType") ? ConfigurationManager.AppSettings["NumberFilterType"].ToString() : "Custom, Numbers";
            string strValidChars = ConfigurationManager.AppSettings.AllKeys.Contains("NumberValidChars") ? ConfigurationManager.AppSettings["NumberValidChars"].ToString() : "; ,.-:/?'\"()_&";
            string strInValidChars = ConfigurationManager.AppSettings.AllKeys.Contains("NumberInvalidChars") ? ConfigurationManager.AppSettings["NumberInvalidChars"].ToString() : "-=<>+|@";
