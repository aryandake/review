...
namespace Fiction2Fact.Projects.Certification
{
    ...
    public partial class Certification_CertificationExCoApproval : System.Web.UI.Page
    {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (Request.QueryString["Type"] != null)
                {
                    ...
                    if (hfType.Value == "L5")
                    {
                        ...
                        if (!string.IsNullOrEmpty(Convert.ToString(Session["ExCoBB"])))
                        {
                            string[] arrVal = Convert.ToString(Session["ExCoBB"]).Split('|');
        ...
        private void getCertification()
        {
            ...
            dtCertDashboard = certBL.getCertificationForPendingApproval("L5", Page.User.Identity.Name.ToString(),
                            strConnectionString);
        ...
        protected void gvCertDashboard_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            ...
            Session["ExCoBB"] = hfDepartmentID.Value + "|" + hfCertDepartment.Value + "|" + hfQuarterId.Value;
        ...
        private void bindApprovalGrid()
        {
            try
            {
                ...
                dt = certBL.getCertificationsApproval(hfDepartmentID.Value, "L5", Page.User.Identity.Name.ToString(),
                    strConnectionString);
            ...
            try
            {
                ...
                if (strOperationType.Equals("A"))
                {
                    if (!strIds.Equals(""))
                    {
                        ...
                        SendApprovalMail(strIds, hfDepartmentID.Value, strFunctionName, strQuarter);
                        //SendIntimationMailToEC(strIds, hfDepartmentID.Value, strFunctionName, strQuarter);
                    }
                }
            }
            catch (Exception ex)
        ...
        private void SendApprovalMail(string strCertIds, string strDepartmentId, string strDepartment, string strQuarter)
        {
            try
            {
                ...
                cc.ParamMap.Add("ConfigId", 2098);
                cc.ParamMap.Add("To", "CCO");
                cc.ParamMap.Add("cc", "EC,Comp,Level3,Level2,Level1");
                //>>
        ...
        private void SendRejectionMail(string strCertIds, string strDepartmentId, string strDepartment, string strQuarter, string strRejectionLevel)
        {
            try
            {
                ...
                {
                    cc.ParamMap.Add("ConfigId", 1097);
                    cc.ParamMap.Add("To", "Level3");
                    cc.ParamMap.Add("cc", "EC,Level2,Level1,Comp");
                }
                cc.ParamMap.Add("SubmittedBy",
                               (new Authentication()).getUserFullName(Page.User.Identity.Name));
