<%@ Page Language="C#" MasterPageFile="~/Projects/Temp3.master" AutoEventWireup="true"
    Inherits="Fiction2Fact.Projects.Submissions.Submissions_ComplianceChecklist" Title="List of Submissions"
    Async="true" CodeBehind="ComplianceChecklist.aspx.cs" %>
        ...
        <div class="col-12">
                        ...
                        <div class="table-responsive">
                            <asp:GridView ID="gvChecklistDetails" EmptyDataText="Checklist Not Available for Selected Month."
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Submitted By" SortExpression="SUB_CREAT_BY">
                                        <ItemTemplate>
                                            <asp:Label ID="lblSubmittedby" Text='<%# Getfullname(Eval("SUB_CREAT_BY").ToString())%>'
                                                runat="server"></asp:Label>
                                            <asp:HiddenField ID="hfSM_CREATE_BY" runat="server" Value='<%#Eval("SM_CREATE_BY") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Approved By" SortExpression="SUB_SUBMITTED_BY" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblApprovedby" Text='<%# Getfullname(Eval("SUB_SUBMITTED_BY").ToString())%>'
                                                runat="server"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Approved On" SortExpression="SUB_SUBMIT_DATE" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblApprovedOn" Text='<%#Eval("SUB_SUBMIT_DATE","{0:dd-MMM-yyyy HH:mm:ss}")%>'
                                                runat="server"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <%-- >>>--%>
         ...
         Attach
                                    ...
                                    <asp:TemplateField ShowHeader="False">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lbSave" runat="server" CssClass="btn btn-outline-success" Width="120" CommandName="Select" Text="Save Draft"
           ...
           <i class="fa fa-save me-2"></i>  Save Draft
            ...
            <i class="fa fa-save me-2"></i>  Submit
                                    ...
                                    <asp:TemplateField HeaderText="Revision suggested By" SortExpression="SUB_REVISION_BY">
                                        <ItemTemplate>
                                            <asp:Label ID="lblSUB_REVISION_BY" Text='<%# Getfullname(Eval("SUB_REVISION_BY").ToString())%>'
                                                runat="server"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Revision suggested On" SortExpression="SUB_REVISION_ON">
                                        <ItemTemplate>
                                            <asp:Label ID="lblSUB_REVISION_ON" Text='<%#Eval("SUB_REVISION_ON","{0:dd-MMM-yyyy HH:mm:ss}")%>'
                                                runat="server"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Revision Remarks" SortExpression="SUB_REVISION_COMMENTS">
                                        <ItemTemplate>
                                            <asp:Label ID="lblSUB_REVISION_COMMENTS" Text='<%#Eval("SUB_REVISION_COMMENTS").ToString().Replace("\n","<br />") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
