<%@ Page Title="" Language="C#" MasterPageFile="~/Projects/Temp3.master" AutoEventWireup="true" Async="true"
    CodeBehind="TrackingDepartmentMaster.aspx.cs" EnableEventValidation="true"
    Inherits="Fiction2Fact.Projects.Submissions.TrackingDepartmentMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        ...
        function onClientEditClick(TrackingDeptId, EmployeeMasterId, TrackingDeptandEmpMappingId) {
            document.getElementById('<%=hfSTM_ID.ClientID%>').value = TrackingDeptId;
            document.getElementById('<%=hfEM_ID.ClientID%>').value = EmployeeMasterId;
            document.getElementById('<%=hfESM_ID.ClientID%>').value = TrackingDeptandEmpMappingId;
        }
    ...
    <asp:HiddenField ID="hfEM_ID" runat="server" />
    <asp:HiddenField ID="hfESM_ID" runat="server" />
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row">
                    <div class="col">
                        <h4 class="page-title">Tracking Department</h4>
                        ...
                        <asp:View ID="vSearch" runat="server">
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">Enter Tracking Department Name:</label>
                                        ...
                                        <asp:TemplateField HeaderText="Edit" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lbEdit" runat="server" CausesValidation="False" CommandName="Select"
                                                    OnClientClick='<%# "onClientEditClick("+ Eval("STM_ID")+","+Eval("EM_ID")+","+Eval("ESM_ID")+")" %>'><i class="fa fa-edit me-2"></i>
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField DataField="STM_TYPE" HeaderText="Tracking Department" SortExpression="STM_TYPE" />
                                        <asp:BoundField DataField="Tracking Status" HeaderText="Tracking Department Status" SortExpression="Tracking Status" />
                                        <asp:BoundField DataField="EM_USERNAME" HeaderText="User Id" SortExpression="EM_USERNAME" />
                                        <asp:BoundField DataField="EM_EMPNAME" HeaderText="Name" SortExpression="EM_EMPNAME" />
                                        <asp:BoundField DataField="EM_EMAIL" HeaderText="Email Id" SortExpression="EM_EMAIL" />
                                        <asp:BoundField DataField="ESM_LEVEL" HeaderText="Level" SortExpression="ESM_LEVEL" />
                                        <asp:BoundField DataField="Employee Status" HeaderText="Employee Status" SortExpression="Employee Status" />
                                    </Columns>
                                </asp:GridView>
                            </div>
                        </asp:View>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <asp:DropDownList ID="ddlSType" CssClass="form-select"
                                        ...
                                        <asp:ListItem Value="D">Tracking Department</asp:ListItem>
                                ...
                                <asp:Panel ID="pnlDepartment" runat="server" Visible="false">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3" id="divDeptReason" runat="server">
                                            ...
                                            <F2FControls:F2FFilteredTextarea runat="server" TargetControlID="txtDeptReasonForEdit" />
                                ...
                                <asp:Panel ID="pnlUsers" runat="server" Visible="false">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <F2FControls:F2FFilteredTextbox runat="server" TargetControlID="txtOUserId" />
								    ...
								    <i class="fa fa-save me-2"></i> Save                    
                                            ...
                                            <asp:LinkButton CssClass="btn btn-outline-danger" ID="lnkReset2" runat="server" CausesValidation="false"
                                                Text="Reset" OnClick="lnkReset_Click">
								    <i class="fa fa-arrow-left me-2"></i> Back
                                            </asp:LinkButton>
                                        </div>
                                    </div>
