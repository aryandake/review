<%@ Page Language="C#" MasterPageFile="~/Projects/Temp3.master" AutoEventWireup="true" Async="true"
    Inherits="Fiction2Fact.Projects.Circulars.MyCertChecklists" Title="My Certification Checklists" CodeBehind="MyCertChecklists.aspx.cs" %>
            ...
            if (IsDoubleClickFlagSet == 'Yes') {
                ...
                if (CheckBoxIDs != null) {
                    ...
                    if (!isAnyChkboxChecked) {
                        if (operation == 'A')
                            msg = msg + '- Please select one or more records to accept the certification checklist';
                        else if (operation == 'R')
                            msg = msg + '- Please select one or more records to reject the certification checklist';
                    }
                }
                if (msg != '') {
                    alert("" + msg);
                    ...
                    if (operation == 'A') {
                        msg = 'Are you sure that you want to accept the certification checklist added?';
                    }
                    else if (operation == 'R') {
                        msg = 'Are you sure that you want to reject the certification checklist added?';
                    }
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row">
                    <div class="col">
                        <h4 class="page-title">My Certification Checklists</h4>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="mb-3">
                        <asp:LinkButton CssClass="btn btn-outline-success" ID="btnAccept" Text="Accept" runat="server" OnClick="btnAccept_Click" OnClientClick="return validate('A');" >
                            <i class="fa fa-check"></i> Accept                               
                        </asp:LinkButton>
                        <asp:LinkButton CssClass="btn btn-outline-danger" ID="btnReject" Text="Reject" runat="server" OnClick="btnReject_Click" OnClientClick="return validate('R');" >
                    ...
                    <div>
                        <div class="table-responsive">
                            <asp:GridView ID="gvCircularMaster" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                GridLines="Both" DataKeyNames="CM_ID" OnRowDataBound="gvCircularMaster_RowDataBound"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Circular Date" SortExpression="CM_DATE">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCircularDate" runat="server" Width="90" Text='<%# Eval("CM_DATE", "{0:dd-MMM-yyyy }") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ShowHeader="true" HeaderText="Subject of the Circular" ItemStyle-Width="100">
                                        <ItemTemplate>
                                            <center>
                                                <%--<asp:LinkButton ID="lbView" runat="server" CssClass="badge rounded-pill badge-soft-pink" OnClientClick='<%# string.Format("showCircularGist(\"{0}\",\"{1}\");", Eval("CM_ID"), Eval("CCC_ID")) %>'
                                                     Text='<%# Eval("CM_TOPIC") %>'>
                                                </asp:LinkButton>--%>
                                    ...
                                    <asp:TemplateField HeaderText="Rejection Remarks (Compliance User)" ShowHeader="true">
                                        <ItemTemplate>
                                            <asp:Label runat="server" Text='<%#Eval("CCC_REJECTION_REMARKS_CU").ToString().Replace("\n","<br />") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="SM_DESC" HeaderText="Status" Visible="false" />
                                </Columns>
                            </asp:GridView>
                        </div>
                    </div>
                    <div class="mt-3">
                        <asp:LinkButton CssClass="btn btn-outline-success" ID="btnAccept1" Text="Accept" runat="server" OnClick="btnAccept_Click" OnClientClick="return validate('A');" >
                            <i class="fa fa-check"></i> Accept   
                        </asp:LinkButton>
                        <asp:LinkButton CssClass="btn btn-outline-danger" ID="btnReject1" Text="Reject" runat="server" OnClick="btnReject_Click" OnClientClick="return validate('R');" >
                            <i class="fa fa-ban"></i> Reject 
                        </asp:LinkButton>
                    </div>
                </div>
