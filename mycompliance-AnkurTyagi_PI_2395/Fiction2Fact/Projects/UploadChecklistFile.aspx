<%@ Page Language="C#" AutoEventWireup="true" Title="Upload File"
    Inherits="UploadChecklistFile" CodeBehind="UploadChecklistFile.aspx.cs" %>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <asp:FileUpload ID="fuException" runat="server" CssClass="form-control" Width="100%" AllowMultiple="true" />
                                        <asp:RegularExpressionValidator ID="revFileUpload1" runat="server" ControlToValidate="fuException"
                                    ...
                                    <div class="text-center mt-3">
                                        <asp:LinkButton CssClass="btn btn-outline-primary" ID="btnUpload" ValidationGroup="SubmitGrp" runat="server"
                                            OnClick="btnProcess_Click" Text="Upload" CausesValidation="true">
