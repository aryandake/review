<%@ Page Language="C#" MasterPageFile="~/Projects/Temp3.master" AutoEventWireup="true"
    Inherits="Fiction2Fact.Projects.Certification.Certification_CertificationCUApproval" Title="Certification Approval"
    Async="true" ValidateRequest="false" CodeBehind="CertificationCUApproval.aspx.cs" %>
    ...
    <script type="text/javascript">
        ...
        function validate(operationType) {
                ...
                if (CheckBoxIDs != null) {
                    for (var i = 1; i < CheckBoxIDs.length; i++) {
                        ...
                        if (cb.checked) {
                            ...
                            if (rowstatus != 'L3A' && rowstatus != 'L4A' && rowstatus != 'L5R') {
                                msg = msg + ' There are approvals pending at the lower levels (as shown in the Status column). ' +
                                    'Hence, you cannot complete review the checklist for row no. ' + i + '.\n';
                            }
                        }
                        else {
                            if (rowstatus == 'L3A') {
                    ...
                    if (!isAllCheckBoxChecked) {
                        msg = msg + 'Review of all records (with status as Submitted) has to be done together. Please select all records (with status as Submitted) to approve.' + '\n';
                    }
                }
            }
            ...
            if (msg != '') {
                ...
                if (operationType == 'Approve') {
                    if (!confirm('Are you sure that you want to review the selected certificate(s)?')) return false;
                    return true;
                }
                else if (operationType == 'Reject') {
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row">
                    <div class="col">
                        <h4 class="page-title">Compliance User Certification Review</h4>
            ...
            <div class="card">
                <div class="card-body">
                    <asp:Panel ID="pnlCertificationDashboards" runat="server" Visible="true">
                        <div class="mb-3">
                            <asp:Label ID="Label1" runat="server" Text="Quarterly Compliance Certificate Checklist for the quarter is pending for review."
                                CssClass="custom-info-alert"></asp:Label>
                        </div>
                        <div class="mb-3">
                            <asp:Label ID="Label2" runat="server" Text="Please click on the 'View' icon to view the quarterly compliance certification of that department."
                    ...
                    <asp:Panel ID="pnlCertDetails" runat="server" Visible="false">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item" style="display: none; visibility: hidden">
                                <a class="nav-link" data-bs-toggle="tab" href="#home" role="tab" aria-selected="true">Certification</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" data-bs-toggle="tab" href="#profile" role="tab" aria-selected="false">Compliance Checklist</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane p-3" id="home" role="tabpanel" style="display: none; visibility: hidden">
                                <div class="row">
                                ...
                                <div id="demo-basic2" visible="false">
                                    <div class="mb-3">
                                        ...
                                        <%--<div class="input-group">
                                            ...
                                            <span>1. Review for all the records have to be done together.</span>
                                        </div>--%>
                                        <div class="input-group">
                                            <i class="fa fa-arrow-alt-circle-right me-2"></i>
                                            <span>1. For revision suggestion, please select the record (click the checkbox), enter the comments and then click on 'Suggest Revision' button.</span>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                            ...
                            <img src="../../Content/images/legacy/EditInformationHS.png" border="0" alt="View Details" style="text-align: center;" />
                                                ...
                                                <asp:TemplateField HeaderText="Department">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:HiddenField ID="hfFunctionId" runat="server" Value='<%#Eval("CDM_ID") %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                    ...
                                    <div class="mt-3">
                                        <asp:LinkButton ID="btnApprove" runat="server" Text="Approve" CssClass="btn btn-outline-success"
                                            ...
                                            <i class="fa fa-paper-plane me-2"></i> Complete Review
                                        </asp:LinkButton>
