<%@ Page Language="C#" MasterPageFile="~/Projects/Temp3.master" AutoEventWireup="true"
    Inherits="Fiction2Fact.Projects.Certification.Certification_CertificationExCoApproval" Title="Certification Approval"
    Async="true" ValidateRequest="false" CodeBehind="CertificationExCoApproval.aspx.cs" %>
            ...
            if (operationType == 'Approve') {
                if (CheckBoxIDs != null) {
                    ...
                    if (!isAllCheckBoxChecked) {
                        msg = msg + 'Approval of all records (with status as Approved by Function Head) has to be done together. Please select all records (with status as Approved by Function Head) to approve.' + '\n';
                    }
                }
            }
                ...
                if (CheckBoxIDs != null) {
                    for (var i = 1; i < CheckBoxIDs.length; i++) {
                        ...
                        if (cb.checked) {
                            ...
                            if (rowstatus == 'L4A') //Approved by FH Head
                            {
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row">
                    <div class="col">
                        <h4 class="page-title">Executive Member Certification Approval</h4>
