<%@ Page Language="C#" MasterPageFile="~/Projects/Temp3.master" AutoEventWireup="true"
    ValidateRequest="false" Async="true" Inherits="Fiction2Fact.Projects.Certification.Certification_EditCertifications"
    Title="Edit Certifications " CodeBehind="EditCertifications.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        function printElement(el) {
            ...
            var shtm = "<head><style type='text/css'>"
            ".normaltext" + "{" + "font-size: 10pt;"
                + "text-align:center;" + "font-family:'Book Antiqua';" + "font-weight:normal;"
        ...
        function printExceptionData() {
            printElement('printarea1');
            return false;
        }
    </script>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row">
                    <div class="col">
                        <h4 class="page-title">View Past Certifications</h4>
                        ...
                        ErrorMessage="Select Quarter.">*</asp:RequiredFieldValidator>--%>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <ajaxToolkit:CascadingDropDown ID="cddLevelSearch" runat="server" TargetControlID="ddlLevelSearch"
                                        ...
                                        Category="CertLevelForView" />
                                    <asp:RequiredFieldValidator ID="rfvSpocDeptName" ValidationGroup="SEARCH" runat="server"
                                        ControlToValidate="ddlLevelSearch" Display="Dynamic" CssClass="text-danger" SetFocusOnError="True">Please select Function Level.</asp:RequiredFieldValidator>
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <ajaxToolkit:CascadingDropDown ID="cddDeptName" runat="server" TargetControlID="ddlDeptName"
                                        ...
                                        ServicePath="AJAXDropdownCertification.asmx" ServiceMethod="GetCertRelevantFuncsBasedOnLevelAndLoggedInUser" />
                                </div>
                            </div>
                                            ...
                                            <ItemTemplate>
                                                <center>
                                                    <asp:LinkButton CssClass="btn btn-sm btn-soft-info btn-circle" runat="server" ID="ibView"
                                                        CommandName="Select" ToolTip="View Details">
                                                        <i class="fa fa-eye"></i>
                                                    </asp:LinkButton>
                                                </center>
                                            </ItemTemplate>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li class="nav-item" style="display: none; visibility: hidden">
                                    <a class="nav-link" data-bs-toggle="tab" href="#home1" role="tab" aria-selected="false">Regulatory Filing</a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane p-3 active" id="home" role="tabpanel">
                                    <div class="mb-3">
                                        <asp:LinkButton CssClass="btn btn-outline-secondary" ID="btnExportToDoc" runat="server" Text="Export to Doc"
                                        ...
                                        <ItemTemplate>
                                            <div class="tabular-view">
                                                ...
                                                <div class="row g-0">
                                                    ...
                                                    <div class="col-md-9">
                                                        <label>
                                                            <%# Eval("CQM_FROM_DATE", "{0:dd-MMM-yyyy}")%>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="row g-0">
                                                    ...
                                                    <div class="col-md-9">
                                                        <label>
                                                            <%# Eval("CQM_TO_DATE", "{0:dd-MMM-yyyy}")%>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="row g-0">
                                    ...
                                    <div class="mt-3">
                                        <asp:LinkButton CssClass="btn btn-outline-secondary" ID="btnExportToDoc2" runat="server" Text="Export to Doc"
                                            OnClick="btnExportToDoc_Click">
                                             <i class="fa fa-download"></i> Export to Doc 
                                        </asp:LinkButton>
                                        <asp:LinkButton CssClass="btn btn-outline-danger" ID="btnViewCancel1" runat="server" Text="Back"
                                            CausesValidation="false" OnClick="btnViewCancel_Click">
                                            <i class="fa fa-arrow-left me-2"></i> Back
                                        </asp:LinkButton>
                                    </div>
                                ...
                                <div class="tab-pane p-3" id="profile" role="tabpanel">
                                    <asp:Panel ID="pnlChecklistShow" runat="server">
                                        ...
                                        <div style="text-align: left">
                                            ...
                                            <asp:LinkButton CssClass="btn btn-outline-danger" ID="btnViewCancel3" runat="server" Text="Back"
                                                CausesValidation="false" OnClick="btnViewCancel_Click">
                                                <i class="fa fa-arrow-left me-2"></i> Back
                                            </asp:LinkButton>
                                        </div>
                                        <div class="mt-3">
                                            <div class="table-responsive">
                                                        ...
                                                        ToolTip='<%#Eval("CCM_CLAUSE")%>'
                                                             runat="server"></asp:Label>--%>
                                                                ...
                                                                <asp:LinkButton ID="lnkbtntxtSections" runat="server" Text='<%#Eval("CCM_CLAUSE").ToString().Length>100?(Eval("CCM_CLAUSE") as string).Substring(0,100).Replace("\n", "<br />") + " ...":Eval("CCM_CLAUSE").ToString().Replace("\n", "<br />")  %>'
                                                                    ToolTip='<%#Eval("CCM_CLAUSE")%>' CssClass="badge rounded-pill badge-soft-pink" OnClientClick='<%# string.Format("return openViewChecklistPopup(\"{0}\");", Eval("CCD_ID")) %>'> </asp:LinkButton>
                                                ...
                                                <asp:BoundField HeaderText="Section/Regulation Rule/Circulars" DataField="CCM_REFERENCE" />--%>
                                                        ...
                                                        <%-- <asp:BoundField HeaderText="Time Limit" DataField="CCM_FREQUENCY" />--%>
                                                        ...
                                                        <asp:TemplateField HeaderText="Action Plan" SortExpression="CCD_ACTION_PLAN">
                                                            <ItemTemplate>
                                                                <%--Text='<%#Eval("CCD_REMARKS").ToString().Replace("\n", "<br />") %>'--%>
                                                                <asp:Label ID="txtRemarks" Text='<%#Eval("CCD_ACTION_PLAN").ToString().Length>100?(Eval("CCD_ACTION_PLAN") as string).Substring(0,100).Replace("\n", "<br />") + " ...":Eval("CCD_ACTION_PLAN").ToString().Replace("\n", "<br />")  %>'
                                                        ...
                                                        <asp:TemplateField HeaderText="Checklist File">
                                                            <ItemTemplate>
                                                                <asp:DataList ID="dlChecklistFiles" runat="server" CellPadding="1"
                                    ...
                                    <div class="mt-3">
                                        <asp:LinkButton CssClass="btn btn-outline-secondary" ID="Button1" runat="server" Text="Export To Excel"
                                            OnClick="btnExportToExcel_Click">
                                            <i class="fa fa-download"></i> Export to Excel 
                                        </asp:LinkButton>
                                        <asp:LinkButton CssClass="btn btn-outline-danger" ID="Button2" runat="server" Text="Back" CausesValidation="false"
                                ...
                                <div class="tab-pane p-3" id="settings" role="tabpanel">
                                    <div style="text-align: left">
                                        ...
                                        <asp:LinkButton CssClass="btn btn-outline-danger" ID="Button3" runat="server" Text="Back" CausesValidation="false"
                                            OnClick="btnViewCancel_Click">
                                            <i class="fa fa-arrow-left me-2"></i> Back 
                                        </asp:LinkButton>
                                    </div>
                                            ...
                                            <asp:GridView ID="gvException" runat="server" AutoGenerateColumns="False" DataKeyNames="CE_ID"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Attached File">
                                                        <ItemTemplate>
                                                            <a href="javascript:void(0)" class="badge rounded-pill badge-soft-pink" onclick="javascript:window.open('../DownloadFileCertification.aspx?FileInformation=<%#(Eval("CE_SERVER_FILE_NAME"))%>','','location=0,status=0,scrollbars=0,width=10,height=10');">
                                    ...
                                    <div style="text-align: left">
                                        <asp:LinkButton CssClass="btn btn-outline-secondary" ID="Button4" runat="server" Text="Export To Excel"
                                            OnClick="btnExportToExcelExceptions_Click">
                                            <i class="fa fa-download"></i> Export to Excel 
                                        </asp:LinkButton>
                                        <asp:LinkButton CssClass="btn btn-outline-danger" ID="Button5" runat="server" Text="Back" CausesValidation="false"
                                            OnClick="btnViewCancel_Click">
                                            <i class="fa fa-arrow-left me-2"></i> Back 
                                        </asp:LinkButton>
                                    </div>
