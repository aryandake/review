...
(function ($, w, undefined) {
    w.footable = {
        options: {
            delay: 100, breakpoints: { phone: 768, tablet: 1024 }, parsers: { alpha: function (cell) { return $(cell).data("value") || $.trim($(cell).text()) } }, toggleSelector: " > tbody > tr:not(.footable-row-detail)", createDetail: function (element, data) {
                var html = "";
                for (var i = 0; i < data.length; i++) {

                    if (i == 0) {
                        html += "<table class='innerTable' width='100%'><tr><td width='50%'><strong>" + data[i].name + "</strong>:</td><td width='50%'> " + data[i].display + "</td></tr>";
                    }
                    else if (i == (data.length - 1)) {
                        html += "<tr><td width='50%'><strong>" + data[i].name + "</strong>:</td><td width='50%'> " + data[i].display + "</td></tr></table>";
                    }
                    else {
                        html += "<tr><td width='50%'><strong>" + data[i].name + "</strong>:</td><td width='50%'> " + data[i].display + "</td></tr>";
                    }

                }
                element.append(html);
            }, classes: { loading: "footable-loading", loaded: "footable-loaded", sorted: "footable-sorted", descending: "footable-sorted-desc", indicator: "footable-sort-indicator" }, debug: false
