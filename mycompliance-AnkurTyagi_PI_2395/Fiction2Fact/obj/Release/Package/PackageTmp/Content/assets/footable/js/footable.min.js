...
(function ($, w, undefined) {
    w.footable = {
        options: {
            delay: 100, breakpoints: { phone: 1366, tablet: 400 }, parsers: { alpha: function (cell) { return $(cell).data("value") || $.trim($(cell).text()) } }, toggleSelector: " > tbody > tr:not(.footable-row-detail)", createDetail: function (element, data) {
                var html = "";
