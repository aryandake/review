...
//{
//    /// <summary>
//   passWord /// This is the exception class that is thrown throughout the Decryption process
//    /// </summary>
    ...
    public static void DecryptFile(string inFile, string outFile, string password)
    {
                  ...
                  fout = File.OpenWrite(outFile))
        {
                      ...
                      chash = new CryptoStream(Stream.Null, hasher, CryptoStreamMode.Write))
            {
                ...
                if (FC_TAG != tag)
                {
                    F2FLog.Log(new CryptoHelpException("File Corrupted!"), (new System.Diagnostics.StackTrace(true)).GetFrame(0).GetFileName(), System.Reflection.MethodBase.GetCurrentMethod().Name);
                ...
                if ((oldHash.Length != read) || (!CheckByteArrays(oldHash, curHash)))
                {
                    ...
                    F2FLog.Log(new CryptoHelpException("File Corrupted!"), (new System.Diagnostics.StackTrace(true)).GetFrame(0).GetFileName(), System.Reflection.MethodBase.GetCurrentMethod().Name); throw new CryptoHelpException("File Corrupted!");
                }
