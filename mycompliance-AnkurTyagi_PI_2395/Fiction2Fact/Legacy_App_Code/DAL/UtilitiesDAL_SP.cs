    ...
    public class UtilitiesDAL_SP
    {
        public DataTable getData(string code, UtilitiesVO utlVO)
        {
            ...
            try
            {
                ...
                {
                    if (code.Equals("getDeptCXO"))
                    {
                        DB.F2FCommand.CommandText = "getUtilityDataVO";
                        DB.F2FCommand.CommandType = CommandType.StoredProcedure;
                        DB.F2FCommand.Parameters.Add(F2FDatabase.F2FParameter("@Type", F2FDatabase.F2FDbType.VarChar, code));
                        DB.F2FCommand.Parameters.Add(F2FDatabase.F2FParameter("@ParamName", F2FDatabase.F2FDbType.VarChar, "CSSDM_ID"));
                        DB.F2FCommand.Parameters.Add(F2FDatabase.F2FParameter("@ParamVal", F2FDatabase.F2FDbType.VarChar, utlVO.getCode()));
                    }
                    else
                    {
                        DB.F2FCommand.CommandText = "getUtilityDataVO";
                        ...
                        DB.F2FCommand.Parameters.Add(F2FDatabase.F2FParameter("@Type", F2FDatabase.F2FDbType.VarChar, code));
                        DB.F2FCommand.Parameters.Add(F2FDatabase.F2FParameter("@Condition", F2FDatabase.F2FDbType.VarChar, utlVO.getCode()));
                    }
            ...
            {
                throw new System.Exception("Exception in getData(): " + ex.Message);
            }
            return resultdata;
            #region Comment           
            ...
            //        case "getAllStatus":
            //            {
            //                strSql = "select * from TBL_STATUS_MASTER " + utlVO.getCode();
            //                break;
            //            }
            //        //>>
            //        //<<Added By Bhavik @ 07 Mar 2014
        ...
        public DataSet getDataSet(string code, string conStr = null)
        {
            ...
            try
            {
                ...
                {
                    DB.OpenConnection();
                    DB.F2FCommand.CommandText = "getUtilityDataSet";
                    DB.F2FCommand.CommandType = CommandType.StoredProcedure;
                    DB.F2FCommand.Parameters.Clear();
                    DB.F2FCommand.Parameters.Add(F2FDatabase.F2FParameter("@Type", F2FDatabase.F2FDbType.VarChar, code));
        ...
        public DataTable getDataSetwithTwoCondition(string code, UtilitiesVO objVO)
        {
            ...
            try
            {
                ...
                {
                    DB.OpenConnection();
                    DB.F2FCommand.CommandText = "getUtilityDataSetwithTwoCondition";
                    DB.F2FCommand.CommandType = CommandType.StoredProcedure;
                    DB.F2FCommand.Parameters.Clear();
                    DB.F2FCommand.Parameters.Add(F2FDatabase.F2FParameter("@Type", F2FDatabase.F2FDbType.VarChar, code));
                    DB.F2FCommand.Parameters.Add(F2FDatabase.F2FParameter("@Condition", F2FDatabase.F2FDbType.VarChar, objVO.getCondition1()));
                    DB.F2FCommand.Parameters.Add(F2FDatabase.F2FParameter("@Condition1", F2FDatabase.F2FDbType.VarChar, objVO.getCondition2()));
                    DB.F2FDataAdapter.Fill(resultdata);
                    DB.CloseConnection();
                }
                #region Comment  getDataSet    
        ...
        public DataTable getDatasetWithConditionInString(string code, string str, string conStr)
        {
            ...
            try
            {
                using (F2FDatabase DB = new F2FDatabase())
                {
                    DB.F2FCommand.CommandText = "getUtilityDatasetWithConditionInString";
                    DB.F2FCommand.CommandType = CommandType.StoredProcedure;
                    DB.F2FCommand.Parameters.Clear();
                    DB.F2FCommand.Parameters.Add(F2FDatabase.F2FParameter("@Type", F2FDatabase.F2FDbType.VarChar, code));
                    DB.F2FCommand.Parameters.Add(F2FDatabase.F2FParameter("@str", F2FDatabase.F2FDbType.VarChar, str));
                    DB.F2FDataAdapter.Fill(resultDataSet);
                }

                #region Commented getDatasetWithConditionInString      
                ...
                //                    "Inner join TBL_CERT_MAS on CDM_ID = CERTM_DEPT_ID and CERTM_LEVEL_ID = 2 " +
                //                    "and CERTM_ID not in " +
                //                    "( " +
        ...
        public DataTable getDatasetWithCondition(string code, int id, string conStr)
        {
            ...
            try
            {
                ...
                {
                    DB.OpenConnection();
                    DB.F2FCommand.CommandText = "getUtilityDatasetWithCondition";
                    DB.F2FCommand.CommandType = CommandType.StoredProcedure;
                    DB.F2FCommand.Parameters.Clear();
                    DB.F2FCommand.Parameters.Add(F2FDatabase.F2FParameter("@Type", F2FDatabase.F2FDbType.VarChar, code));
                    DB.F2FCommand.Parameters.Add(F2FDatabase.F2FParameter("@ID", F2FDatabase.F2FDbType.VarChar, id));
                    DB.F2FDataAdapter.Fill(resultDataSet);
                    DB.CloseConnection();
                }
                #region Commented getDatasetWithCondition   
                //            string strSql = "";
                ...
                //                    {
                //                        strSql = "select CAM_NAME,CAM_ID from TBL_CIRCULAR_AREA_MAS where CAM_CIA_ID=" + id + " order by CAM_NAME";
                //                        break;
                //                    }
        ...
        public DataSet getDataset(string code, string conStr)
        {
            ...
            try
            {
                ...
                {
                    DB.OpenConnection();
                    DB.F2FCommand.CommandText = "getUtilityData";
                    DB.F2FCommand.CommandType = CommandType.StoredProcedure;
                    DB.F2FCommand.Parameters.Clear();
                    DB.F2FCommand.Parameters.Add(F2FDatabase.F2FParameter("@Type", F2FDatabase.F2FDbType.VarChar, code));
                    DB.F2FDataAdapter.Fill(resultDataSet);
                ...
                //    case "SUBMISSIONSGMT":
                //        {
                //            strSql = "select SSM_ID,SSM_NAME from TBL_SUBMISSION_SEGMENT_MAS order by SSM_NAME ";
                //            break;
                //        }
                //    case "TYPE":
                //        {
                ...
                //    case "EVENT":
                //        {
                //            strSql = "SELECT EM_ID, EM_EVENT_NAME FROM TBL_EVENT_MAS ORDER BY EM_EVENT_NAME";
                //            break;
                //        }
                ...
                //    case "AllFinYears":
                //        {
                //            strSql = "SELECT FYM_ID,FYM_FIN_YEAR, FYM_STATUS FROM TBL_FIN_YEAR_MAS  ORDER BY FYM_FIN_YEAR ";
                //            break;
                //        }
                ...
                //        {
                //            strSql = "select CIM_ID,CIM_TYPE from TBL_CIRCULAR_INTIMATIONS_MASTER order by CIM_TYPE ";
                //            break;
                //        }
                ...
                //    case "ISS":
                //        {
                //            strSql = "select CIA_ID,CIA_NAME from TBL_CIRCULAR_ISSUING_AUTHORITIES order by CIA_NAME ";
                //            break;
                //        }
        ...
        public DataTable getDatasetWithMoreCondition(string code, int condition1, int condition2, string conStr)
        {
            ...
            try
            {
                ...
                {
                    DB.OpenConnection();
                    DB.F2FCommand.CommandText = "getUtilityDatasetWithMoreCondition";
                    DB.F2FCommand.CommandType = CommandType.StoredProcedure;
                    DB.F2FCommand.Parameters.Clear();
                    DB.F2FCommand.Parameters.Add(F2FDatabase.F2FParameter("@Type", F2FDatabase.F2FDbType.VarChar, code));
                    DB.F2FCommand.Parameters.Add(F2FDatabase.F2FParameter("@Type", F2FDatabase.F2FDbType.Int32, condition1));
                    DB.F2FCommand.Parameters.Add(F2FDatabase.F2FParameter("@Type", F2FDatabase.F2FDbType.Int32, condition2));
                    DB.F2FDataAdapter.Fill(resultDataSet);
                    DB.CloseConnection();
                }
                #region Commented getDatasetWithMoreCondition
                //string strSql = "";
                //switch (code)
                //{
        ...
        public DataTable getDatasetWithTwoConditionInString(string code, string str1, string str2, string conStr)
        {
            ...
            try
            {
                ...
                {
                    DB.OpenConnection();
                    DB.F2FCommand.CommandText = "getUtilityDatasetWithTwoConditionInString";
                    DB.F2FCommand.CommandType = CommandType.StoredProcedure;
                    DB.F2FCommand.Parameters.Clear();
                    DB.F2FCommand.Parameters.Add(F2FDatabase.F2FParameter("@Type", F2FDatabase.F2FDbType.VarChar, code));
                    DB.F2FCommand.Parameters.Add(F2FDatabase.F2FParameter("@Condition", F2FDatabase.F2FDbType.VarChar, str1.Replace("'", "''")));
                    DB.F2FCommand.Parameters.Add(F2FDatabase.F2FParameter("@Condition1", F2FDatabase.F2FDbType.VarChar, str2.Replace("'", "''")));
                    DB.F2FDataAdapter.Fill(resultDataSet);
                    DB.CloseConnection();
                }
                #region Commented getDatasetWithTwoConditionInString
        ...
        public DataTable getDatasetWithThreeConditionInString(string code, string str1, string str2, string str3, string conStr)
        {
            ...
            try
            {
                ...
                {
                    DB.OpenConnection();
                    DB.F2FCommand.CommandText = "getUtilitDatasetWithThreeConditionInString";
                    DB.F2FCommand.CommandType = CommandType.StoredProcedure;
                    DB.F2FCommand.Parameters.Clear();
                    DB.F2FCommand.Parameters.Add(F2FDatabase.F2FParameter("@Type", F2FDatabase.F2FDbType.VarChar, code));
                    DB.F2FCommand.Parameters.Add(F2FDatabase.F2FParameter("@str1", F2FDatabase.F2FDbType.VarChar, str1.Replace("'", "''")));
                    DB.F2FCommand.Parameters.Add(F2FDatabase.F2FParameter("@str2", F2FDatabase.F2FDbType.VarChar, str2.Replace("'", "''")));
                    DB.F2FCommand.Parameters.Add(F2FDatabase.F2FParameter("@str3", F2FDatabase.F2FDbType.VarChar, str3.Replace("'", "''")));
                    DB.F2FDataAdapter.Fill(resultDataSet);
                    DB.CloseConnection();
                }
                #region Commented getUtilitDatasetWithThreeConditionInString
                //string strSql = "";
                //switch (code)
                //{
        ...
        public DataTable getDatasetWithThreeConditionsInString(string code, string str, int intLevel, string conStr)
        {
            ...
            try
            {
                return getDatasetWithThreeConditionInString(code, str, intLevel.ToString(), "", conStr);
                //string strSql = "";
                //switch (code)
                //{
                //    case "getCertContentById":
