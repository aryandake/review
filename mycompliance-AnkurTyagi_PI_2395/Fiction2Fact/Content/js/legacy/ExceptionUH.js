...
function getExceptionDetailsOnSave() 
{
	try 
	{
		...
		var OperationType = document.getElementById('ctl00_ContentPlaceHolder1_hfOperationType').value;
		...
		{	
		    ...
		    if (OperationType == 'Approve')
            {
		        ...
		        {
		            alert("Please check the 'I hereby confirm that I have read the key ...' checkbox to approve "+
		            " the certification.");
		            return false;
		        }
		        else
